  ...
  return (
    <div className="flex flex-col h-full">
      <div className="flex-1 overflow-y-auto bg-gray-50">
        <div className="bg-gradient-to-br from-purple-600 to-purple-700 text-white px-6 pt-8 pb-20 rounded-b-3xl">
          ...
          <p className="text-purple-100 text-sm">System overview and approvals</p>
        </div>
        ...
        <div className="px-6 -mt-16">
          <div className="bg-white rounded-2xl shadow-lg p-5 mb-6">
            ...
            <div className="relative">
              ...
              <select
                ...
                className="w-full pl-12 pr-4 py-3 border-2 border-purple-300 rounded-xl focus:outline-none focus:border-purple-600 appearance-none bg-white text-gray-900 font-medium"
              >
          ...
          <div className="flex gap-4 mb-6">
            <button className="px-6 py-2 bg-purple-600 text-white rounded-full font-semibold">
              Overview
            </button>
            <button className="px-6 py-2 bg-white text-gray-700 rounded-full font-semibold border border-gray-200">
              Approvals
            </button>
          </div>
